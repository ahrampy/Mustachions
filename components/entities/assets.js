...
const Images = {
  ...
  items: {
    ...
    computerOn: require("../../assets/images/room_elements/computer_on.png"),
    computerOff: require("../../assets/images/room_elements/computer_off.png"),
    lampOn: require("../../assets/images/room_elements/lamp_on.png"),
    lampOff: require("../../assets/images/room_elements/lamp_off.png"),
